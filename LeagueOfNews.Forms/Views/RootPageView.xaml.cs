...
namespace LeagueOfNews.Forms.Views
{
    ...
    {
        public RootPageView() => InitializeComponent();

        protected override void OnViewModelSet() => ViewModel.HideMaster += ViewModel_HideMaster;

        private void ViewModel_HideMaster(object sender, System.EventArgs e) => IsPresented = false;
    }
}